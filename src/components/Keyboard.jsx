        ...
        <div class="keyboard">
            ...
            <div class="buttons">
                ...
                <div class="button__plmin" onClick={() => dispatch(addToExample("-"))}>
                    <img src="http://localhost:9999/assets/plmin.svg" alt="" />
                </div>
                    <div class="button__percent" onClick={() => dispatch(addToExample("%"))}>
                        <img src="http://localhost:9999/assets/percent.svg" alt="" />
                    </div>
                    <div class="button__act" onClick={() => dispatch(addToExample("/"))}>
                        <img src="http://localhost:9999/assets/split.svg" alt="" />
                    </div>
                    ...
                    <div class="button__act" onClick={() => dispatch(addToExample("*"))}>
                        <img src="http://localhost:9999/assets/mult.svg" alt="" />
                    </div>
                    ...
                    <div class="button__act" onClick={() => dispatch(addToExample("-"))}>
                        <img src="http://localhost:9999/assets/-.svg" alt="" />
                    </div>
